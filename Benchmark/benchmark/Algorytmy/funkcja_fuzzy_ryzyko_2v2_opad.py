# Algorytmy/funkcja_fuzzy_ryzyko_2v2_opad.py
#
# Jak funkcja_fuzzy_ryzyko_2v2.py (cel z funkcji ryzyka, wykonawczo silnik
# FL2v2, 7 reguł), ale setpoint liczony przez
...
class KontrolerFuzzyRyzyko2v2Opad(KontrolerRyzykaOpadBazowy):
