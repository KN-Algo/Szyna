# Algorytmy/funkcja_mpc_miekkie_zabezpieczony.py
#
...
# _MPCMachineryMixinZabezpieczony zamiast po _MPCMachineryMixin - patrz tam pełny
# opis DWÓCH warstw zabezpieczeń (kontrola jakości dopasowania SOPDT + krzyżowa
# kontrola bieżącego pomiaru HRT). Celowo OSOBNY, zarejestrowany algorytm (nie
# zmiana istniejącego mpc_miekkie_ograniczenia) - na życzenie użytkownika
...
class KontrolerMPCMiekkieZabezpieczony(_MPCMachineryMixinZabezpieczony, KontrolerRyzykaOpadBazowy):
    ...
    def mpc_miekkie_zabezpieczony(self, row_data):
