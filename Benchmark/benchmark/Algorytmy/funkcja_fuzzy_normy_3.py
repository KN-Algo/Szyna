# Algorytmy/funkcja_fuzzy_normy_3.py
#
# Jak funkcja_fuzzy_normy_1.py, ale regulator wykonawczy to silnik FL3 -
# moc rozmyta liczona RAZ na okno 60s i rozdzielona w czasie PWM (patrz
# silniki_fuzzy.WykonawcaPWM). Cel z normy LET-1 pobierany na początku
# każdego cyklu PWM - patrz funkcja_normy_wspolne.py.
...
class KontrolerFuzzyNormy3(KontrolerNormyCiaglaBazowy):
