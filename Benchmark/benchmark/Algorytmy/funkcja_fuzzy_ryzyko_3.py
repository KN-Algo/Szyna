# Algorytmy/funkcja_fuzzy_ryzyko_3.py
#
# Jak funkcja_fuzzy_ryzyko_1.py, ale regulator wykonawczy to silnik FL3 -
# moc rozmyta liczona RAZ na okno 60s i rozdzielona w czasie PWM (patrz
# silniki_fuzzy.WykonawcaPWM). _evaluate_risk_setpoint jest wołane co sekundę
# niezależnie od cyklu PWM (żeby pamięć/prognoza Kalmana widziała KAŻDĄ
# próbkę), ale nowy cel dla silnika rozmytego pobierany jest tylko na
# początku każdego cyklu PWM.
...
class KontrolerFuzzyRyzyko3(KontrolerRyzykaBazowy):
